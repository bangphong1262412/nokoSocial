            ...
            <div className='home_left'>
               ...
               <div className="sidebar">
                <div className="menu-item">
                    ...
                    </span> <span className="menu-item-name">Home</span>
                </div>
           ...
           <div className='profile-middle'>
...

            {
                ...
                <div className="profile_tab">
                    <span className={saveTab ? '' : 'active'} onClick={() => setSaveTab(false)}>Posts</span>
                    <span className={saveTab ? 'active' : ''} onClick={() => setSaveTab(true)}>Saved</span>
                </div>
            }
